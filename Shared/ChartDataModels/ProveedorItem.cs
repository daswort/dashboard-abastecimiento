namespace DashboardAbast.Shared.ChartDataModels
{
    public class ProveedorItem
    {
        ...
        private readonly List<string> _colorSet = new()
        {
            ...
            "#FFFFFF", "#F5F5F5", "#FFFF00"
        };

        public ProveedorItem(string nombre, DataItem[] data)
        {
            var random = new Random();
            this.Nombre = nombre;
            this.Color = _colorSet[random.Next(_colorSet.Count)];
            this.Data = data;
        }
    }
}
