...
namespace DashboardAbast.Server.Controllers
{
    ...
    [ApiController]
    public class ResumenProveedorController : ControllerBase
    {
        ...
        public ResumenProveedorController(
        ...
        [HttpGet]
        public async Task<ActionResult> GetResumenProveedor()
        {
            ...
            //System.Diagnostics.Debug.WriteLine("fechaActual: " + fechaActual);
            //System.Diagnostics.Debug.WriteLine("fechaUnMesAtras: " + fechaUnMesAtras);
            ...
            proveedorParametros.ListaRut = qr4.Select(x => x.CodigoProveedor).Distinct().ToList();
            var proveedoresList = await Ent4.GetProveedoresByListOfIDs(proveedorParametros).AsNoTracking().ToListAsync();
            ...
            var qr5 = (from t1 in qr4
                       ...
                       join t3 in proveedoresList on t1.CodigoProveedor equals t3.ProveedorId
                       select new
                       {
                           CodigoProveedor = t1.CodigoProveedor,
                           NombreProveedor = t3.ProveedorAlias,
                           //NumOc = t1.NumOC,
            ...
            var qr6 = qr5
                .GroupBy(g => new { g.CodigoProveedor, g.NombreProveedor })
                .Select(g => new
                {
                    Codigo = g.Key.CodigoProveedor,
                    Nombre = g.Key.NombreProveedor,
                    Total = g.Count(),
